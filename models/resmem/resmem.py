...
if __name__ == "__main__":
    model = ResMem(pretrained=False)
    model.load_state_dict(torch.load("/data/dingsd/projects/img2emo_anyproject/output/resmem_pretrained_model_weights/model.pt", weights_only=False, map_location="cpu"))
