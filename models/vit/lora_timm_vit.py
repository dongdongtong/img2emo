...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        self.qkv = lora.MergedLinear(dim, dim * 3, bias=qkv_bias, r=lora_reduction, enable_lora=[True, False, True])
...
def _create_vision_transformer(variant: str, pretrained: bool = False, pretrained_strict=True, **kwargs) -> VisionTransformer:
...
@register_model
def vit_large_patch14_clip_224_lora(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_huge_patch14_clip_224_lora(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_giant_patch14_clip_224_lora(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_gigantic_patch14_clip_224_lora(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_giant_patch14_224_lora(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ ViT-Giant (little-g) model (ViT-g/14) from `Scaling Vision Transformers` - https://arxiv.org/abs/2106.04560
    """
...
@register_model
def vit_giant_patch14_dinov2_lora(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ ViT-G/14 for DINOv2
    """
...
@register_model
def vit_giant_patch14_reg4_dinov2_lora(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ ViT-G/14 for DINOv2
    """
    # The hidden_features of SwiGLU is calculated by:
    # hidden_features = (int(hidden_features * 2 / 3) + 7) // 8 * 8
...
@register_model
def vit_gigantic_patch14_224_lora(pretrained: bool = False, **kwargs) -> VisionTransformer:
